...
class _RecipeViewState extends State<RecipeView> {
  ...
  void initState() {
    super.initState();
    ratingController.fetchRatingsData(widget.food['idMeal'] ?? '');
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 1; i <= 20; i++) {
      final ingredient = widget.food['strIngredient$i'] as String?;
      final measure = widget.food['strMeasure$i'] as String?;
